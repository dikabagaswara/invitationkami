...
export default function CelestialTheme({ data }: { data: ThemeData }) {
  ...
  return (
    <div className="min-h-screen bg-[#0A071B] text-[#E0DCFC] font-sans selection:bg-[#7C3AED] selection:text-white relative overflow-x-hidden">
      {/* ─── AMBIENT STARFIELD & NEBULA GLOW ─── */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-40 left-1/4 w-[700px] h-[700px] bg-purple-900/30 rounded-full blur-[170px] animate-pulse"></div>
        <div className="absolute top-1/2 -right-40 w-[600px] h-[600px] bg-indigo-950/40 rounded-full blur-[160px]"></div>
        <div className="absolute bottom-10 left-10 w-[700px] h-[700px] bg-violet-950/35 rounded-full blur-[180px]"></div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-24 sm:space-y-36">
        ...
        {sectionConfig.hero && (
          <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center">
            ...
            <div className="relative w-full max-w-3xl rounded-[3rem] p-8 sm:p-16 backdrop-blur-2xl bg-[#140F2D]/75 border border-[#8B5CF6]/30 shadow-[0_0_60px_rgba(139,92,246,0.15)] overflow-hidden">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-7xl font-serif text-white tracking-wide leading-tight my-3">
